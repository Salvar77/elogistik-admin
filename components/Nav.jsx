...
const Nav = ({ show }) => {
  ...
  return (
    <aside className={`${classes.nav} ${show ? classes["nav--show"] : ""}`}>
      ...
      <nav>
        <Link
          href={"/"}
          className={
            pathname === "/" ? classes.nav__mainTwoActive : classes.nav__main
          }
        >
          <svg
        ...
        <button onClick={logout} className={classes.nav__logout}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <span className={`${classes.nav__span} ${classes.nav__spanTwo}`}>
            Wyloguj
          </span>
        </button>
      </nav>
